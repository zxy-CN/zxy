...
public class RegisterController {
    ...
    public JsonResult<Map> getBase(){
        ...
        //自动生成病历号到前端
        String sdf=new SimpleDateFormat("yyyyMMdd").format(new Date()).toString();
        String caseNumber=sdf+(registerService.getCount()+1000);
        String sdf1=new SimpleDateFormat("yyMMdd").format(new Date()).toString();
        String invoiceNumber=sdf1+(invoiceService.getCount()+100);
        //取常数数据,性别
